...
public class MyRealm extends AuthorizingRealm {
    ...
    public SimpleAuthorizationInfo setRolesAndPermissions(Long userId) {
        ...
        List<RoleDTO> roles = roleService.listRoles(userId);
        ...
        for (RoleDTO role : roles) {
            ...
            setPermissions(info, role.getRoleId());
        }

        return info;
    }

    private void setPermissions(SimpleAuthorizationInfo info, Long roleId) {

        List<PermissionDTO> permissions = permissionService.listPermissions(roleId);
